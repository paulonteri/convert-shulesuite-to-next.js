...
describe("Students", () => {
    ...
    it("Dashboard", () => {
        ...
        cy.url().should("eq", Cypress.config().baseUrl + "/staff/students");
    });

    it("Student Add", () => {
        cy.visit("/staff/students/add");
        cy.get("#first_name");
        cy.get("h5");
        ...
        cy.url().should("eq", Cypress.config().baseUrl + "/staff/students/add");
    });

    it("Student Table", () => {
        cy.visit("/staff/students/table");
        ...
        cy.url().should(
            "eq",
            Cypress.config().baseUrl + "/staff/students/table"
        );
    });
});
